...
public class SVG {
    ...
    public void agregarTriangulo(Triangulo triangulo) {
      Linea l1 = new Linea(triangulo.getp1(), triangulo.getp2());
      Linea l2 = new Linea(triangulo.getp1(), triangulo.getp2());
      Linea l3 = new Linea(triangulo.getp1(), triangulo.getp2());

      /*
       *Se pudo haber realizado todo este procedimiento, pero ya que tienes el metodo de AgregarLinea,simplemente funciona con ese, lo pense muy tarde.
      String tl1 = "<line x1\"" + l1.getp1().getX() + "\" " + "y1=\"" + (altura - l1.getp1().getY()) + "\" " + "x2=\"" + l1.getp2().getX() + "\" " + "y2=\"" + (altura - l1.getp2().getY());
      String tl2 = "<line x1\"" + l2.getp1().getX() + "\" " + "y1=\"" + (altura - l2.getp1().getY()) + "\" " + "x3=\"" + l2.getp3().getX() + "\" " + "y3=\"" + (altura - l2.getp3().getY());
      String tl3 = "<line x2\"" + l3.getp2().getX() + "\" " + "y2=\"" + (altura - l3.getp2().getY()) + "\" " + "x3=\"" + l3.getp3().getX() + "\" " + "y3=\"" + (altura - l3.getp3().getY());
      concatenar(tl1+tl2+tl3);
      */
      agregarLinea(l1);
      agregarLinea(l2);
      agregarLinea(l3);
